...
describe WorksController do
  ...
  describe "logged in users" do
    ...
    describe "upvote" do
      it "succeeds for a logged-in user and a fresh user-vote pair" do
        another_work = works(:movie)

        expect{
          post upvote_path(another_work), params: {}
      ...
      it "redirects to the work page if the user has already voted for that work" do
        vote = Vote.create(user: user, work: existing_work)
  ...
  describe "guest users (not-logged in)" do
    ...
    describe "upvote" do
      it "redirects to main page if no user is logged in" do
        expect{
          post upvote_path(existing_work)
        }.wont_change "Vote.count"
